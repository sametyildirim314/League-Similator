...
// GetLeagueTable handles the request to get the current league table
...
// GetLeagueTableForWeek handles the request to get the league table at a specific week
